...
- [Chapter 19 — Loop engineering: the internal and external project cycles](ch19-loop-engineering.md) · Four nested internal loops (gradient/search/structure/adaptation) mapped to the three overfitting levels, the external federation loop with its event protocol and co-adaptation stability laws, the ~300-line build process, and the operating runbook. *(Discussion 8.)*
